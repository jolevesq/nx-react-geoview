...
import '../assets/i18n/i18n'; //../assests/i18n/i18n';
...
import { Shell } from '@geo-view/shell';
        ...
        return parse(html, {
            ...
            replace: (domNode) => {
                ...
                if (domNodeElement.attribs && domNodeElement.attribs['class'] && domNodeElement.attribs['class'] === 'llwp-map') {
                    ...
                    // );
                    const configObj = { 'id': 'xyz', 'language': 'fr-CA',
                    'configuration': { 'name': 'LCCEN', 'projection': 3978, 'zoom': 4, 'center': [60,-100], 'language': 'fr-CA', 'basemapOptions': { 'id': 'transport', 'shaded': true, 'labeled': true }, 'layers': [] } };
